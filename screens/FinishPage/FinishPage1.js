  ...
  render() {
    return (
      ...
      <View style={{ width: width - 30, textAlign: "center" }}>
        <Header
          left={<TouchableOpacity onPress={() => this.props.navigation.navigate('MainPage')}><Quit /></TouchableOpacity>}
        ...
        <View style={{ width: width-30, marginBottom:20 }}>
          <Button buttonTitle="Продолжить" onPress={() => this.props.navigation.navigate('FinishPage2')}/>
        </View>
      </View>
      </SafeAreaView>
      </View>
